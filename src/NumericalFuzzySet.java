...
public class NumericalFuzzySet extends FuzzySet {
     ...
     * @param maxSupport
     */
    public NumericalFuzzySet(int i, String label, double minSupport, double minCore, double maxCore, double maxSupport) {
        super(i, label);
    ...
    public String toString() {
        return "(" + id + ")" + label +" {" + "minSupport = " + this.minSupport + "\t minCore = " + this.minCore + "\t maxCore = " + this.maxCore + "\t maxSupport = " + this.maxSupport + '}';
    }
